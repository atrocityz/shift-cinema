...
export interface Car {
     ...
     * Марка автомобиля
     */
    brand: 'Garden car' | 'Geely' | 'Grocery cart' | 'Haier' | 'Haval' | 'Hyundai' | 'Invalid' | 'Kia' | 'Mercedes' | 'Volkswagen';
    /**
     * Цвет автомобиля
     */
...
export interface PizzaIngredient {
     ...
     */
    type: 'BACON' | 'BASIL' | 'CHEDDAR' | 'CHICKEN_FILLET' | 'CHILE' | 'FETA' | 'GREEN_PEPPER' | 'HAM' | 'MEATBALLS' | 'MOZZARELLA' | 'MUSHROOMS' | 'ONION' | 'PARMESAN' | 'PEPERONI' | 'PICKLE' | 'PINEAPPLE' | 'SHRIMPS' | 'TOMATO';
}
...
export interface OrderedPizza {
     ...
     * Топпинги
     */
    toppings: Array<'BACON' | 'BASIL' | 'CHEDDAR' | 'CHICKEN_FILLET' | 'CHILE' | 'FETA' | 'GREEN_PEPPER' | 'HAM' | 'MEATBALLS' | 'MOZZARELLA' | 'MUSHROOMS' | 'ONION' | 'PARMESAN' | 'PEPERONI' | 'PICKLE' | 'PINEAPPLE' | 'SHRIMPS' | 'TOMATO'>;
}
...
export type AndroidSampleControllerGetLoanFeedResponse = AndroidSampleControllerGetLoanFeedResponses[keyof AndroidSampleControllerGetLoanFeedResponses];
...
export type AndroidSampleControllerGetFullLoanResponse = AndroidSampleControllerGetFullLoanResponses[keyof AndroidSampleControllerGetFullLoanResponses];
...
export type TesterControllerSessionResponse = TesterControllerSessionResponses[keyof TesterControllerSessionResponses];
